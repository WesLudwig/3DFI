...
if __name__ == "__main__":
	...
	if "snakemake" in globals():
		jcast_dir = snakemake.input.jcast_dir
		swissprot_tsv = snakemake.input.swissprot_tsv
		isoform_csv = snakemake.output.isoform_csv
		plot_file = snakemake.output.plot_file

		main(
			input_directory = jcast_dir,
			output_file = isoform_csv,
